...
config.General.requestName = '/Oct_RunC'
config.JobType.psetName = '/afs/cern.ch/work/z/zhixing/private/CMSSW_9_4_0/src/CMSDIJET/DijetRootTreeMaker/prod/flat-data-cfg_miniAOD_C.py'
